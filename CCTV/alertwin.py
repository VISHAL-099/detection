            ...
            try:
                ...
                while not self.stop_flag:
                    ...
                    if all(frame is None for frame in frames):
                        ...
                        processed_frames = [
                            process_frame(frame, self.start_time, self.alerts_callback)
...
class DetectionApp(QMainWindow):
    def __init__(self):
        ...
        #self.button_list.setFixedWidth(700)
        ...
        #self.alert_box.setFixedHeight(300)  # Adjust height of alert box
